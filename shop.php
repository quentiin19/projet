	...
	<section class="top-page">
        ...
        <div class="col-md-4 col-xs-12 col-sm-4">
          ...
          <div class="logo text-center">
            <a href="index.html">
              <!-- replace logo here -->
              <svg width="205px" height="29px" viewBox="0 0 155 29" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" font-size="40" font-family="AustinBold, Austin" font-weight="bold">
                  <g id="Group" transform="translate(-108.000000, -297.000000)" fill="#000000">
                    <text id="fashion">
                      <tspan x="108.94" y="325">FASHION</tspan>
                    </text>
                  </g>
                </g>
              </svg>
        ...
        <div class="col-md-9">
          <div class="row">
            <div class="col-md-4">
              <div class="product-item">
                <div class="product-thumb">
                  ...
                  <img class="img-responsive" src="images/product-1.jpg" alt="product-img">
            ...
            <div class="col-md-4">
              <div class="product-item">
                <div class="product-thumb">
                  <img class="img-responsive" src="images/product-2.jpg" alt="product-img">
                  <div class="preview-meta">
                    <ul>
                      <li>
                        <a href="product-single.html"><i class="fa fa-search"></i></a>
            ...
            <div class="col-md-4">
              <div class="product-item">
                <div class="product-thumb">
                  <img class="img-responsive" src="images/product-3.jpg" alt="product-img">
                  <div class="preview-meta">
                    <ul>
                      <li>
                        <a href="product-single.html"><i class="fa fa-search"></i></a>
            ...
            <div class="col-md-4">
              <div class="product-item">
                <div class="product-thumb">
                  <img class="img-responsive" src="images/product-4.jpg" alt="product-img">
                  <div class="preview-meta">
                    <ul>
                      <li>
                        <a href="product-single.html"><i class="fa fa-search"></i></a>
            ...
            <div class="col-md-4">
              <div class="product-item">
                <div class="product-thumb">
                  <span class="bage">Sale</span>
                  <img class="img-responsive" src="images/product-5.jpg" alt="product-img">
                  <div class="preview-meta">
                    <ul>
                      <li>
                        <a href="product-single.html"><i class="fa fa-search"></i></a>
            ...
            <div class="col-md-4">
              <div class="product-item">
                <div class="product-thumb">
                  <img class="img-responsive" src="images/product-6.jpg" alt="product-img">
                  <div class="preview-meta">
                    <ul>
                      <li>
                        <a href="product-single.html"><i class="fa fa-search"></i></a>
            ...
            <div class="col-md-4">
              <div class="product-item">
                <div class="product-thumb">
                  <img class="img-responsive" src="images/product-7.jpg" alt="product-img">
                  <div class="preview-meta">
                    <ul>
                      <li>
                        <a href="product-single.html"><i class="fa fa-search"></i></a>
            ...
            <div class="col-md-4">
              <div class="product-item">
                <div class="product-thumb">
                  <img class="img-responsive" src="images/product-8.jpg" alt="product-img">
                  <div class="preview-meta">
                    <ul>
                      <li>
                        <a href="product-single.html"><i class="fa fa-search"></i></a>
            ...
            <div class="col-md-4">
              <div class="product-item">
                <div class="product-thumb">
                  <img class="img-responsive" src="images/product-9.jpg" alt="product-img">
                  <div class="preview-meta">
                    <ul>
                      <li>
                        <a href="product-single.html"><i class="fa fa-search"></i></a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <p class="copyright-text">Copyright &#9400; Fashion</p>
        </div>
      </div>
    </div>
  </footer>
